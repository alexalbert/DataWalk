  ...
  function () {
    ...
    _proto.topics = function topics() {
      return {
        ...
        "Nobel Prizes": this.sparqlNobels // "Nobel Prizes (slower)": this.sparqlNobelsWiki
...
define('topics/sparql-nobels',["exports", "aurelia-framework"], function (_exports, _aureliaFramework) {
  ...
  function () {
    ...
    _proto.query = function query(filter, withWiki) {
      var WIKI_CLAUSE1 = this.withWiki ? " SERVICE <http://dbpedia.org/sparql?default-graph-uri=http://dbpedia.org>\n      {\n        ?wklink foaf:isPrimaryTopicOf ?Wiki .\n      }" : "";
      var WIKI_CLAUSE2 = this.withWiki ? " ?p owl:sameAs ?wklink ." : "";
